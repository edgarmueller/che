...
import org.eclipse.che.plugin.sampleactions.ide.action.CreateMyFileAction;
...
public class SampleActionsExtensions {
    ...
    public SampleActionsExtensions(
            ...
            CreateMyFileAction createMyFileAction) {
        ...
        sampleGroup.add(createMyFileAction);
